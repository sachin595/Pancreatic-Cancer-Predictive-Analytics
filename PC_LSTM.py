...
model = load('PCmodel.joblib')
scalerX = load('PCscalerX.joblib')
scalerY = load('PCscalerY.joblib')
scalerT = load('PCscalerT.joblib')
...
st.title('Predictive Analytics for Pancreatic Cancer')
